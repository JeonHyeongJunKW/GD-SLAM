...
public:
    ...
    cv::Mat GrabImageRGBD_GD(const cv::Mat &imRGB, const cv::Mat &imD, cv::Mat &mask,cv::Mat &origin_mask,const double &timestamp, cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut);
