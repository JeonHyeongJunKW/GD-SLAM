...
if __name__=="__main__":
	test = Mask()
	test_zero = np.zeros((480, 640))
	result = test.GetDynSeg(test_zero)
	print(result.shape)
	result = test.GetOriginMask()
	print(result.shape)
